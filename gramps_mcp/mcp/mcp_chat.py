...
def register_chat_tools(mcp: FastMCP):
    @mcp.tool(tags={"chat"})
    async def gramps_chat(
        action: str = Field(description="Action to perform. One of: 'post_chat'"),
        ...
        """Manage Gramps chat operations. CONCEPT:GM-OS.identity.grmp."""
        if ctx:
            await ctx.info("Executing Gramps chat operation")
